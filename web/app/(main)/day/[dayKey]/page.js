  ...
  return (
    <Box
      ...
      sx={{
        touchAction: 'pan-y',
        width: '100%',
        // روی دسکتاپ کارها و ادیتور کنار هم می‌نشینند (پایین‌تر)، پس قاب باید
        // واقعاً پهن شود — وگرنه دو ستونِ نصف‌نصف هرکدام از ستون تکیِ قبلی
        // باریک‌تر می‌شوند و کنار هم گذاشتن‌شان فضا نمی‌دهد، می‌گیرد. ۱۷۶۰
        // یعنی روی نمایشگر ۱۹۲۰ تقریباً تمام عرض، و روی نمایشگرهای بزرگ‌تر
        // باز هم طول خط ادیتور از حد خوانایی بیرون نمی‌زند. موبایل: همان ۷۲۰.
        maxWidth: { xs: 720, md: 1760 },
        mx: 'auto',
        display: 'flex',
